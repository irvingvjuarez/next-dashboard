...
const Loading = () => {
  return (
    <div className="grid place-content-center w-full h-full py-8">
      <div className="flex justify-center items-center space-x-1 text-sm text-gray-700">
        <svg fill="none" className="w-9 h-9 animate-spin" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
