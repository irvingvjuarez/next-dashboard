									...
									<div className="hidden md:block">
										<div className="ml-4 flex items-center md:ml-6">
											...
											<Menu as="div" className="ml-3 relative">
												<div>
													<Menu.Button className="overflow-hidden h-8 w-8 max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
														<span className="sr-only">Open user menu</span>
														<img className="max-w-[none] h-full" src={user.avatar} alt="" />
													</Menu.Button>
												</div>
												<Transition
													as={Fragment}
